...
import { FiCamera, FiChevronUp, FiMapPin } from "react-icons/fi";
        ...
        <div className="container relative">
          <div className="grid grid-cols-1 pb-8 text-center mt-10">
            <h3 className="text-3xl leading-normal tracking-wider font-semibold text-white">
              {data?.title ? data.title : "New Zealand’s South Island brims with majestic"}
            </h3>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-12 grid-cols-1 gap-6">
            <div className="lg:col-span-8 md:col-span-7">
              ...
              <p className="flex items-center text-slate-400 font-medium mt-2">
                ...
                {data?.place ? data.place : "New Zealand"}
              </p>
              ...
              <div className="mt-6">
                ...
                <p className="text-slate-400 mt-6">
                  ...
                  which more or less corresponds to 'proper' Latin. It contains a series of real
                  Latin words. This ancient dummy text is also incomprehensible, but it imitates the
                  rhythm of most European languages in Latin script.
                </p>
                <p className="text-slate-400 mt-3">
                  The advantage of its Latin origin and the relative meaninglessness of Lorum Ipsum
                  is that the text does not attract attention to itself or distract the viewer's
