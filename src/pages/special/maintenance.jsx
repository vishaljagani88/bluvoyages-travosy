...
export default function Maintenance() {
  ...
  return (
    <>
      <section className="relative h-screen flex items-center justify-center text-center bg-[url('../../assets/images/bg/cta.jpg')] bg-no-repeat bg-center bg-cover">
        ...
        <div className="container relative">
          <div className="grid grid-cols-1">
            ...
            <p className="text-white/70 text-lg max-w-xl mx-auto">
              Start working with Travosy that can provide everything you need to generate awareness,
          ...
          <div className="grid grid-cols-1 mt-10">
            <div className="text-center">
              <span id="maintenance" className="timer text-white text-[56px] tracking-[1px]">
