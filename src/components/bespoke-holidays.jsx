...
export default function BespokeHolidays() {
  return (
    <div className="container relative md:mt-24 mt-16">
      <div className="grid grid-cols-1 pb-8 text-center">
        <h3 className="mb-6 md:text-3xl text-2xl md:leading-normal leading-normal font-semibold">
          Bespoke Holidays & Unusual Experiences
        </h3>
      </div>
      <div className="grid md:grid-cols-12 grid-cols-1 items-center gap-6 relative">
            ...
            <div className="absolute flex items-center bottom-16 md:-start-10 -start-5 p-4 rounded-lg shadow-md dark:shadow-gray-800 bg-white dark:bg-slate-900 w-56 m-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-xl font-bold">
                  <CountUp className="counter-value" start={0} end={1235} />
                </p>
              </div>
            </div>
        ...
        <div className="md:col-span-7">
          <div className="lg:ms-8">
            <h3 className="mb-6 md:text-3xl text-2xl md:leading-normal leading-normal font-semibold">
              Designing vacations since 2003 <br /> Creating memories for a lifetime
            </h3>

            <p className="text-slate-400 max-w-xl mb-6">
              Hansa Holidays is a boutique holiday company; started by Vani Subhas & Usha Reddy, in
              2003.
            </p>

            <p className="text-slate-400 max-w-xl mb-6">
              We specialise in bespoke, luxury vacations for leisure and business. From ticketing,
              to visas, to planning every detail of your vacation, our team is going to take care of
              every little detail to make your vacation dreams come true.
            </p>
            ...
            >
              Read More <i className="mdi mdi-chevron-right align-middle ms-0.5"></i>
            </Link>
          </div>
        </div>
